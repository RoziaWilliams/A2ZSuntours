...
using A2ZSuntours.Models;

namespace A2ZSuntours.Controllers
{
    public class TourController : Controller
    {
        private A2ZDbModels db = new A2ZDbModels();
        ...
        /*[HttpPost]
        public ActionResult Tous(A2ZDbModels vm)
        {
        ...
        public ActionResult Create([Bind(Include = "TripID,TripName,TripLoc")] Trip trip)
        {
            if (ModelState.IsValid)
            {
                db.Trips.Add(trip);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TripID,TripName,TripLoc")] Trip trip)
        {
            if (ModelState.IsValid)
            {
